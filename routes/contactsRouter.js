...
contactsRouter.post("/", validateBody(schemas.createContactSchema), contactsController.createContact);

contactsRouter.put("/:contactId", validateBody(schemas.updateContactSchema), contactsController.updateContact);
